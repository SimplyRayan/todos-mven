    ...
    <div class="form-box">
      <form>
        <div class="form-item">
          ...
          <input type="text" id="name" required v-model="name.val" />
          <p v-if="!name.isValid" class="error">{{ name.reason }}</p>
        </div>
        <div class="form-item">
  ...
  methods: {
    validatePassword() {
      if (this.password.val === "") {
        ...
        this.password.isValid = false;
        this.password.reason = "Passowrd can't be shorter than 6 charachters";
        return false;
      }
    ...
    validateName() {
      if (this.name.val === "") {
        ...
        this.name.reason = "Please enter your name";
        return false;
      }
